...
const Conferencechair = () => {
  return (
    <section id="Conferencechair" className="mx-auto w-5/6 py-20">
      <motion.div
      // onViewportEnter={() => setSelectedPage(SelectedPage.Conferencechair)}
      >
        {/* HEADER */}
        <motion.div
